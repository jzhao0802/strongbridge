...
```{r}
vdf <- df %>% dplyr::select(contains("_flag"))
...
```{r}
write_rds(hc, paste0(path, "/01_data/cluster_dfs/gilead/", "flag_hc_obj.rds"))
write_rds(hc_cut, paste0(path, "/01_data/cluster_dfs/gilead/", "flag_hc_cut.rds"))
write_rds(agg_vdf, paste0(path, "/01_data/cluster_dfs/gilead/", "flag_x_clustering_tr_agg_sum.rds"))
write_csv(clust_memb, paste0(path, "/01_data/cluster_dfs/gilead/", "flag_clust_memb_table.csv"), na="")
```
