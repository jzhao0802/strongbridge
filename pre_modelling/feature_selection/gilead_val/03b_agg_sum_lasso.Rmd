...
```{r}
adf_tr <- read_rds(paste0(path, "/01_data/cluster_dfs/gilead/", "x_clustering_tr_agg_sum.rds"))
...
write.csv(pr_lasso_bin,paste0(path,"/01_data/cluster_dfs/gilead/pr_lasso_cluster_sum.csv"))
```
