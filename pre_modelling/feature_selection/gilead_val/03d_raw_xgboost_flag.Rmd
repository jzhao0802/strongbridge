...
write_rds(xgb.pred ,paste0(path,"/01_data/cluster_dfs/gilead/fit_xgb_raw_flag.rds"))
```
...
write.csv(importance_matrix ,paste0(path,"/01_data/cluster_dfs/gilead/xgb_vi_flag.csv"))
```
...
write.csv(pr_xgb_bin ,paste0(path,"/01_data/cluster_dfs/gilead/pr_xgb_raw_flag.csv"))
```
