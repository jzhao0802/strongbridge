...
```{r}
write_rds(hc, paste0(results_dir, "hc_obj_400.rds"))
write_rds(hc_cut, paste0(results_dir, "hc_cut_400.rds"))
write_rds(agg_vdf, paste0(results_dir, "x_clustering_tr_agg_sum_400.rds"))
write_csv(clust_memb, paste0(results_dir, "clust_memb_table_400.csv"), na="")
```
